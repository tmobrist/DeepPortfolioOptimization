...
#opened by globaldatamatrix during download-data, only if online=True
class CoinList(object):
    """
    Input: Poloniex, Get_chart_until_success

    """


    def __init__(self, end=1483315200, volume_average_days=30, volume_forward=0.08):
    ...
    # get several days volume of the coin
    ...
    #used during coin selection in globaldatamatrix during online, n=coin_number, returns the n coins with the biggest volume
