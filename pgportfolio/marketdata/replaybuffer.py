...
import numpy as np
import logging
#initialized by datamatrices during download data
class ReplayBuffer:
    ...
    #used from datamatrices during rollingrainer, appends a new experience and logges it
    ...
    #gives the geometric random distribution viewed from the end point
    ...
    #used by next batch in datamatrices to sample the next batch
