...
class HistoryManager:
    ...
    #used in datamatrices, returns a panel with the features
    def get_global_panel(self, start, end, period=300, features=('close',)):
        ...
        self.__coins = coins
        #updates data and fills the gaps in the data base
        for coin in coins:
        ...
        #error if period wrong initialized
    ...
    #start=end - self.__volume_forward - 30 * DAY, end=end - self._volume_forward, returns the coins with the biggest volume
    ...
    def __fill_data(self, start, end, coin, cursor):
        #get data from self._df initialized before
